...
static Equihash<48, 3> Eh48_3;
static Equihash<144,8> Eh144_8;

#define EhInitialiseState(n, k, base_state)  \
	if (n == 48 && k == 3) {				 \
		Eh48_3.InitialiseState(base_state);  \
	} else if (n == 96 && k == 3) {          \
        ...
        Eh144_8.InitialiseState(base_state);  \
    } else if (n == 48 && k == 5) {          \
...
{
	if (n == 48 && k == 3) {
		return Eh48_3.BasicSolve(base_state, validBlock, cancelled);
	} else if (n == 96 && k == 3) {
		...
		return Eh144_8.BasicSolve(base_state, validBlock, cancelled);
	} else if (n == 48 && k == 5) {
...
{
	if (n == 48 && k == 3) {
		return Eh48_3.OptimisedSolve(base_state, validBlock, cancelled);
	} else if (n == 96 && k == 3) {
		...
		return Eh144_8.OptimisedSolve(base_state, validBlock, cancelled);
	} else if (n == 48 && k == 5) {
...
#define EhIsValidSolution(n, k, base_state, soln, ret)   \
	if (n == 48 && k == 3) {                             \
        ret = Eh48_3.IsValidSolution(base_state, soln);  \
	} else if (n == 96 && k == 3) {                      \
        ...
        ret = Eh144_8.IsValidSolution(base_state, soln);  \
    } else if (n == 48 && k == 5) {                      \
